		...
		new WebpackDeployer({
		  environments: {
		    staging: {
		      region: 'us-west-1',
		      params: {
		        Bucket: 'static.startribune.com/staging/news/projects/all/placefinder/build',
		        DistributionId: 'placefinder'
		      }
		    },
		    production: {
		      region: 'us-west-1',
		      params: {
		        Bucket: 'static.startribune.com/news/projects/all/placefinder/build',
		        DistributionId: 'placefinder'
		      }
		    }
		  },
